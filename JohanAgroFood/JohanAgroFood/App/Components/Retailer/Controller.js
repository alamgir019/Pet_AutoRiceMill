app.controller("RetailerCtrl", function ($scope, retailerService) {
    GetAll();
    GetAllRetailerType();
    GetAllDistrict();
    GetAllThana();
    ...
    //To Get All Records  
    function GetAll() {
        var Data = retailerService.getRetailer();
 ...
 //To Get All Zone  
   ...
   /* $scope.Locations = [{ RETAILERLOCATIONID: 1, RETAILERLOCATIONNAME: "Gulshan" },{ RETAILERLOCATIONID: 2, RETAILERLOCATIONNAME: "Badda" }];
    ...
    $scope.gridOptions = {
        paginationPageSizes: [25, 30, 35],
        paginationPageSize: 25,
        data: 'retailers',
        columnDefs: [
          { field: 'RETAILERNAME', displayName: 'Retailer Name' },
          { field: 'RETAILERCODE', displayName: 'CODE' },
          { field: 'RETAILERADDRESS', displayName: 'Retailer Address' },
          { field: 'RETAILERPERSON', displayName: 'Person' },
          { field: 'RETAILERMOBILE1', displayName: 'Mobile No' },
          { field: 'RETAILERSTATUS', displayName: 'Retailer Status' }
        ],
