...
export class PartyServiceProxy {
     ...
     * @return Success
     */
    getAll(isActive: boolean | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<ListResultDtoOfPartyListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfPartyListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfPartyListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfPartyListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfPartyListDto.fromJS(resultData200) : new ListResultDtoOfPartyListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfPartyListDto>(<any>null);
    }
}
...
export class ListResultDtoOfPartyListDto implements IListResultDtoOfPartyListDto {
    items: PartyListDto[] | undefined;

    constructor(data?: IListResultDtoOfPartyListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(PartyListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfPartyListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfPartyListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfPartyListDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfPartyListDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfPartyListDto {
    items: PartyListDto[] | undefined;
}

export class PartyListDto implements IPartyListDto {
    ...
    constructor(data?: IPartyListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PartyListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PartyListDto();
        result.init(data);
        return result;
    }
...
export interface IPartyListDto {
    name: string | undefined;
    contactNo: string | undefined;
    area: string | undefined;
    districtId: number | undefined;
