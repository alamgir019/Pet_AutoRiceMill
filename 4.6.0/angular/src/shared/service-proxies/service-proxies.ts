...
@Injectable()
export class ModuleForTestServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getMessage(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ModuleForTest/GetMessage";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetMessage(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PartyServiceProxy {
     ...
     * @return Success
     */
    getAll(isActive: boolean | null | undefined): Observable<ListResultDtoOfPartyDto> {
        let url_ = this.baseUrl + "/api/services/app/Party/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfPartyDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfPartyDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfPartyDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfPartyDto.fromJS(resultData200) : new ListResultDtoOfPartyDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfPartyDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: CreatePartyInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Party/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    updateParty(input: UpdatePartyInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Party/UpdateParty";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateParty(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateParty(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateParty(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<PartyDto> {
        let url_ = this.baseUrl + "/api/services/app/Party/Get?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PartyDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PartyDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PartyDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PartyDto.fromJS(resultData200) : new PartyDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PartyDto>(<any>null);
    }
    ...
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Party/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class SubModule1ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    getMessage(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SubModule1/GetMessage";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getInfo(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SubModule1/GetInfo";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetInfo(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class SubModule2ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    getMessage(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SubModule2/GetMessage";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getInfo(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/SubModule2/GetInfo";
        url_ = url_.replace(/[?&]$/, "");
...
export class ListResultDtoOfPartyDto implements IListResultDtoOfPartyDto {
    items: PartyDto[] | undefined;

    constructor(data?: IListResultDtoOfPartyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(PartyDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfPartyDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfPartyDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfPartyDto {
    items: PartyDto[] | undefined;
}
...
export class PartyDto implements IPartyDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.isCashParty = data["isCashParty"];
    ...
    toJSON(data?: any) {
        ...
        data["isCashParty"] = this.isCashParty;
...
export class CreatePartyInput implements ICreatePartyInput {
    name: string;
    contactNo: string | undefined;
    area: string | undefined;
    isActive: boolean | undefined;

    constructor(data?: ICreatePartyInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreatePartyInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreatePartyInput();
        result.init(data);
        return result;
    }
...
export class UpdatePartyInput implements IUpdatePartyInput {
    id: number | undefined;
    name: string;
    contactNo: string | undefined;
    area: string | undefined;
    ...
    constructor(data?: IUpdatePartyInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdatePartyInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdatePartyInput();
        result.init(data);
        return result;
    }
...
export interface IUpdatePartyInput {
    id: number | undefined;
    name: string;
    contactNo: string | undefined;
    area: string | undefined;
